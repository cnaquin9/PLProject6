...
_lr_productions = [
  ...
  ('atom -> SIMB','atom',1,'p_atom_simbol','yacc.py',188),
  ('atom -> bool','atom',1,'p_atom_bool','yacc.py',192),
  ('atom -> NUM','atom',1,'p_atom_num','yacc.py',196),
  ('atom -> TEXT','atom',1,'p_atom_word','yacc.py',200),
  ('atom -> <empty>','atom',0,'p_atom_empty','yacc.py',204),
  ('bool -> TRUE','bool',1,'p_true','yacc.py',208),
  ('bool -> FALSE','bool',1,'p_false','yacc.py',212),
  ('atom -> NIL','atom',1,'p_nil','yacc.py',216),
]
